...
// Property Info - Updated with real JSON data
...
This spacious, newly renovated 3-bedroom, 2-bathroom casa in St. Petersburg, Florida is the perfect family-friendly beach retreat. This single-story home blends comfort and style, offering plenty of space to relax just 5 minutes from the beach. Ideal for families, groups, and extended stays.

Treat yourself to a heated pool (available October 1st to May 1st) for $20 per day as an add-on.

For beach days, we've got you covered with beach towels, chairs, umbrellas, sunscreen, and a beach stroller, making every outing effortless and enjoyable. We also provide 2 bicycles for guest use, complete with locks for your convenience.`,
  ...
  host: {
    ...
    pictureUrl: 'https://a0.muscache.com/im/pictures/user/User/original/0d98cc6f-3738-4c73-8557-ececc66e0200.jpeg',
    isSuperhost: true,
    responseRate: '100%',
  ...
  images: [
    ...
    'https://a0.muscache.com/im/pictures/hosting/Hosting-1489399156507737323/original/00cc535a-7bb4-400f-b339-c2d2dd2d580e.jpeg?aki_policy=large',
    'https://a0.muscache.com/im/pictures/hosting/Hosting-1489399156507737323/original/f413e410-1397-4abd-a0fe-70144372a754.jpeg?aki_policy=large',
    'https://a0.muscache.com/im/pictures/hosting/Hosting-1489399156507737323/original/134541cd-d513-4bc7-8206-f748410ec880.jpeg?aki_policy=large',
    'https://a0.muscache.com/im/pictures/hosting/Hosting-1489399156507737323/original/db10c187-9a83-4051-9861-9c04460bbe57.jpeg?aki_policy=large',
    'https://a0.muscache.com/im/pictures/hosting/Hosting-1489399156507737323/original/3217814f-8e6a-4591-9d44-d9a40bdeb8b3.jpeg?aki_policy=large'
  ],
}
...
export const reviews: Review[] = [
  {
    ...
    roomType: 'casa',
    rating: 5,
    comment: 'Our month stay was more than we expected. This house is so adorable. Felt like home from day 1. Beautifully decorated and updated. Quiet neighborhood and a 5 minute drive to Madeira Beach. Any minor questions we had were responded to immediately by the hosts. If you are looking for a peaceful place to stay on your Florida vacation I strongly recommend you give this house consideration.',
    cleanliness: 5,
    location: 5,
    service: 5,
    value: 5,
  ...
  },
  {
    ...
    roomType: 'casa',
    rating: 5,
    comment: 'My family had an amazing stay. Kids loved the heated pool and we loved the private jacuzzi. We used the provided bikes to get around because everything was super close. Home had QR codes for easy WiFi and food/location suggestions. House was extremely clean and cozy. Thank you - will definitely come back!',
    cleanliness: 5,
    location: 5,
    service: 5,
    value: 5,
  ...
  },
  {
    ...
    roomType: 'casa',
    rating: 4,
    comment: 'Super communicative, hosts were lovely. Just what we needed for our holiday vacation.',
    cleanliness: 5,
    location: 5,
    service: 5,
    value: 4,
  ...
  },
  {
    ...
    roomType: 'casa',
    rating: 5,
    comment: 'Angelica\'s home is beautifully decorated with a beachy vibe. We were able to bike to bars, restaurants, and stores. Angelica was very responsive and promptly answered all my questions. We\'ll be staying here again!',
    cleanliness: 5,
    location: 5,
    service: 5,
    value: 5,
  ...
  },
  {
    ...
    roomType: 'casa',
    rating: 5,
    comment: 'Host was very quick to respond. House was nice.',
    cleanliness: 5,
    location: 5,
    service: 5,
    value: 5,
  ...
  },
  {
    ...
    roomType: 'casa',
    rating: 5,
    comment: 'We really enjoyed our weekend stay! Although we didn\'t spend much time in the house, it was clean, comfortable, and had everything we needed. The pool area was absolutely beautiful and peaceful - perfect for relaxing. The location was great too, close to plenty of restaurants and attractions.',
    cleanliness: 5,
    location: 5,
    service: 5,
    value: 5,
  ...
  },
  {
    ...
    roomType: 'casa',
    rating: 5,
    comment: 'We simply loved this home! It was 5 minutes from the Beach and Walmart was just around the corner, so that was a huge plus. The children enjoyed the pool. We would definitely stay here again! The Host was great at communicating as well, very nice lady.',
    cleanliness: 5,
    location: 5,
    service: 5,
    value: 5,
