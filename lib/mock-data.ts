...
export const propertyInfo: PropertyInfo = {
  ...
  description: 'Experience luxury at its finest. Our beachfront resort offers world-class amenities, stunning ocean views, and impeccable service. Whether you\'re seeking a romantic getaway or a family vacation, Grand Azure Resort provides an unforgettable stay.',
...
export const rooms: Room[] = [
  {
    ...
    type: 'standard',
    name: 'Standard Room',
    description: 'Comfortable and cozy, our Standard Room features modern amenities with city or garden views. Perfect for solo travelers or couples seeking a comfortable retreat.',
    capacity: 2,
    beds: '1 Queen Bed',
    size: 28,
    amenities: ['WiFi', 'Air Conditioning', 'Flat Screen TV', 'Mini Bar', 'Safe', 'Coffee Maker', 'Hairdryer', 'Iron'],
    images: [
  ...
  },
  {
    ...
    type: 'deluxe',
    name: 'Deluxe Room',
    description: 'Upgrade your stay with our Deluxe Room featuring ocean views, premium bedding, and enhanced amenities. Spacious layout perfect for relaxation.',
    capacity: 2,
    beds: '1 King Bed',
    size: 38,
    amenities: ['WiFi', 'Air Conditioning', 'Flat Screen TV', 'Mini Bar', 'Safe', 'Coffee Maker', 'Hairdryer', 'Iron', 'Bathrobe', 'Ocean View', 'Balcony'],
    images: [
  ...
  },
  {
    ...
    type: 'family-suite',
    name: 'Family Suite',
    description: 'Designed for families, this spacious suite features separate living and sleeping areas, two bathrooms, and kid-friendly amenities. Create lasting memories together.',
    capacity: 4,
    beds: '1 King Bed + 2 Twin Beds',
    size: 55,
    amenities: ['WiFi', 'Air Conditioning', 'Flat Screen TV', 'Mini Bar', 'Safe', 'Coffee Maker', 'Hairdryer', 'Iron', 'Bathrobe', 'Ocean View', 'Balcony', 'Kitchenette', 'Dining Area', 'Living Room'],
    images: [
  ...
  },
  {
    ...
    type: 'luxury-suite',
    name: 'Luxury Suite',
    description: 'Indulge in opulence with our Luxury Suite. Featuring panoramic ocean views, a private terrace, jacuzzi, and butler service. The epitome of sophisticated living.',
    capacity: 2,
    beds: '1 King Bed',
    size: 75,
    amenities: ['WiFi', 'Air Conditioning', 'Flat Screen TV', 'Mini Bar', 'Safe', 'Coffee Maker', 'Hairdryer', 'Iron', 'Bathrobe', 'Panoramic Ocean View', 'Private Terrace', 'Jacuzzi', 'Butler Service', 'Living Room', 'Dining Room', 'Walk-in Closet'],
    images: [
  ...
  },
  {
    ...
    description: 'The crown jewel of Grand Azure Resort. This exclusive penthouse features 360-degree views, private pool, chef\'s kitchen, and dedicated staff. An unparalleled luxury experience.',
    capacity: 4,
    beds: '2 King Beds',
    size: 150,
    amenities: ['WiFi', 'Air Conditioning', 'Flat Screen TV', 'Mini Bar', 'Safe', 'Coffee Maker', 'Hairdryer', 'Iron', 'Bathrobe', '360° Views', 'Private Pool', 'Chef\'s Kitchen', 'Dedicated Staff', 'Home Theater', 'Spa Room', 'Private Elevator', 'Gym'],
    images: [
      'https://images.unsplash.com/photo-1594563703937-fba6d2dc5af0?w=800',
      'https://images.unsplash.com/photo-1608198399988-341f712c3711?w=800',
...
export const reviews: Review[] = [
  {
    ...
    roomType: 'luxury-suite',
    rating: 5,
    comment: 'Absolutely stunning property! The Luxury Suite exceeded all expectations. The staff was incredibly attentive and the ocean views were breathtaking. Will definitely be returning!',
    cleanliness: 5,
    location: 5,
    service: 5,
    value: 4,
  ...
  },
  {
    ...
    roomType: 'deluxe',
    rating: 4,
    comment: 'Great business trip stay. The WiFi was fast and reliable, perfect for work. The only minor issue was some noise from the hallway early morning.',
    cleanliness: 5,
    location: 4,
    service: 4,
    value: 4,
  ...
  },
  {
    ...
    roomType: 'family-suite',
    rating: 5,
    comment: 'Perfect for families! Our kids loved the pool and the suite had everything we needed. The staff went above and beyond to accommodate our dietary restrictions.',
    cleanliness: 5,
    location: 5,
    service: 5,
    value: 5,
  ...
  },
  {
    ...
    roomType: 'penthouse',
    rating: 5,
    comment: 'The Penthouse is simply magnificent. The private pool, the views, the service - everything was flawless. This is true luxury.',
    cleanliness: 5,
    location: 5,
    service: 5,
    value: 5,
  ...
  },
  {
    ...
    roomType: 'deluxe',
    rating: 4,
    comment: 'Beautiful property with excellent amenities. The spa was a highlight of our stay. Would have loved a bit more variety at breakfast.',
    cleanliness: 4,
    location: 5,
    service: 4,
    value: 4,
