...
// Property Info (sincronizado con listing JSON)
export const propertyInfo: PropertyInfo = {
  ...
  checkInTime: listingDetail.checkInTime ?? '16:00',
  checkOutTime: listingDetail.checkOutTime ?? '12:00',
  amenities: [
    'Piscina climatizada',
    'Cerca de Madeira Beach',
    'Cocina equipada',
  ...
  policies: listingDetail.houseRulesModule?.structuredRules?.map((r) => r.text) ?? [
    'Check-in: 16:00 - Check-out: 12:00',
    'Niños bienvenidos',
    'Admite mascotas (una por reserva)',
    'Prohibido fumar',
    'No fiestas ni eventos',
  ],
  images: listingDetail.photos.slice(0, 8).map((p) => p.large),
}
...
// Reviews (con respuesta del host cuando existe, del JSON)
export const reviews: Review[] = [
  { id: '1631349364838882271', guestName: 'Jane', guestAvatar: 'https://a0.muscache.com/im/pictures/user/User/original/86b21a30-7428-4a8e-a348-f5905502c9d1.jpeg', reservationId: 'res-1', roomType: 'casa', rating: 5, comment: 'Nuestra estancia de un mes fue más de lo que esperábamos. Esta casa es adorable. Me sentí como en casa desde el primer día. Hermosamente decorado y actualizado. Barrio tranquilo y a 5 minutos en coche de Madeira Beach. Los anfitriones respondieron de inmediato a cualquier duda menor que tuviéramos.', cleanliness: 5, location: 5, service: 5, value: 5, createdAt: '2026-02-28', localizedDate: 'Hace 1 semana' },
  { id: '1579932103126731326', guestName: 'Brendan', guestAvatar: 'https://a0.muscache.com/im/pictures/user/User/original/50cc5d04-b56a-4ddd-a7ae-9795c0a89de4.jpeg', reservationId: 'res-2', roomType: 'casa', rating: 5, comment: 'Mi familia tuvo una estancia increíble. A los niños les encantó la piscina climatizada y a nosotros nos encantó el jacuzzi privado. Utilizamos las bicicletas que nos proporcionaron para desplazarnos, porque todo estaba muy cerca. La casa estaba extremadamente limpia y acogedora.', cleanliness: 5, location: 5, service: 5, value: 5, createdAt: '2025-12-19', localizedDate: 'diciembre de 2025', hostResponse: '¡Obrigada con você por cuidar tan bien de nuestra casa, sois bienvenidos en cualquier momento!' },
  { id: '1565347923697077173', guestName: 'Kim', guestAvatar: 'https://a0.muscache.com/im/pictures/user/cb793f97-04f5-49cc-ab97-265140b09685.jpg', reservationId: 'res-3', roomType: 'casa', rating: 4, comment: 'Supercomunicativo, los anfitriones eran encantadores. Justo lo que necesitábamos para nuestras vacaciones.', cleanliness: 4, location: 4, service: 4, value: 4, createdAt: '2025-11-29', localizedDate: 'noviembre de 2025', hostResponse: 'Obrigada por tu reseña, Kim. Hicimos todo lo posible para atender todas vuestras peticiones. ¡Te deseamos lo mejor en tus futuros viajes!' },
  { id: '1557462157452668388', guestName: 'Shelley', guestAvatar: 'https://a0.muscache.com/im/Portrait/Avatars/messaging/b3e03835-ade9-4eb7-a0bb-2466ab9a534d.jpg?im_t=S&im_w=240&im_f=airbnb-cereal-medium.ttf&im_c=ffffff', reservationId: 'res-4', roomType: 'casa', rating: 5, comment: 'La casa de Angelica está bellamente decorada con un ambiente playero. Pudimos ir en bicicleta a bares, restaurantes y tiendas. Angelica fue muy receptiva y respondió rápidamente a todas mis preguntas.', cleanliness: 5, location: 5, service: 5, value: 5, createdAt: '2025-11-18', localizedDate: 'noviembre de 2025', hostResponse: 'Obrigada por ficar conosco. Ha sido un placer recibirte y nos alegra mucho que hayas disfrutado de tu estancia. Siempre serás bienvenido si regresas.' },
  { id: '1539256083714683989', guestName: 'Angela', guestAvatar: 'https://a0.muscache.com/im/pictures/user/User/original/b322b4da-8e76-4a48-86cb-4ea76d262583.jpeg', reservationId: 'res-5', roomType: 'casa', rating: 5, comment: 'El anfitrión respondió rápidamente. La casa era bonita.', cleanliness: 5, location: 5, service: 5, value: 5, createdAt: '2025-10-24', localizedDate: 'octubre de 2025', hostResponse: 'Obrigada com você. Disfrutamos mucho hospedándote y nos alegra mucho saber que tuviste una estancia estupenda. Te damos la bienvenida cuando quieras.' },
  { id: '1536416297532015016', guestName: 'Kennette', guestAvatar: 'https://a0.muscache.com/im/pictures/user/17717ccc-a7b0-434f-a41d-780667bf17e0.jpg', reservationId: 'res-1', roomType: 'casa', rating: 5, comment: '¡Disfrutamos mucho de nuestra estancia de fin de semana! Aunque no pasamos mucho tiempo en la casa, estaba limpia, cómoda y tenía todo lo que necesitábamos. La zona de la piscina era absolutamente hermosa y tranquila.', cleanliness: 5, location: 5, service: 5, value: 5, createdAt: '2025-10-20', localizedDate: 'octubre de 2025', hostResponse: 'Thank you for taking the time to leave such a wonderful review. ¡Muito obrigada! You\'re welcome back anytime.' },
  { id: '1526934009560979894', guestName: 'Michelle', guestAvatar: 'https://a0.muscache.com/im/pictures/user/User/original/d711f364-6aea-4087-8fda-adfbd333754a.jpeg', reservationId: 'res-2', roomType: 'casa', rating: 5, comment: '¡Nos encantó este alojamiento! Estaba a 5 minutos de la playa y Walmart estaba a la vuelta de la esquina. Los niños disfrutaron de la piscina... ¡Sin duda, volveríamos a repetir! La anfitriona también fue genial.', cleanliness: 5, location: 5, service: 5, value: 5, createdAt: '2025-10-07', localizedDate: 'octubre de 2025', hostResponse: '¡Gracias por hospedarte en nuestro alojamiento! Nos encantó hospedar a tu familia. ¡Siempre seréis bienvenidos en cualquier momento!' },
  { id: '1515354565141340879', guestName: 'Christopher', guestAvatar: 'https://a0.muscache.com/im/pictures/user/d28674e6-a1d3-4000-a89e-eb1a71739d57.jpg', reservationId: 'res-3', roomType: 'casa', rating: 5, comment: '¡Gran estancia! ¡A mi familia le encantó este Airbnb! Los anfitriones fueron educados y la hospitalidad fue absolutamente impresionante, ¡volveremos!', cleanliness: 5, location: 5, service: 5, value: 5, createdAt: '2025-09-21', localizedDate: 'septiembre de 2025', hostResponse: 'Thank you so much for your kind words! We look forward to welcoming you back to Areia Bela anytime!' },
  { id: '1506691483231641240', guestName: 'Eduardo', guestAvatar: 'https://a0.muscache.com/im/pictures/user/User/original/c20a09e1-99b3-43ba-ae73-810a740cd782.jpeg', reservationId: 'res-4', roomType: 'casa', rating: 5, comment: 'Ya me había alojado en San Petersburgo antes, pero el Airbnb de Angelica ha sido la experiencia más especial hasta la fecha. Todas las habitaciones tenían códigos QR con actividades divertidas. La casa era exactamente igual que en las fotos.', cleanliness: 5, location: 5, service: 5, value: 5, createdAt: '2025-09-09', localizedDate: 'septiembre de 2025', hostResponse: '¡Muito obrigado por tu maravillosa evaluación! Estamos deseando volver a recibirte a ti y a tu esposa en Areia Bela pronto, ¡sempre bem-vindos!' },
  { id: '1505216952857874565', guestName: 'Lucy', guestAvatar: 'https://a0.muscache.com/im/pictures/user/232918a1-a94a-4fe8-80e6-ab307e7bda0f.jpg', reservationId: 'res-5', roomType: 'casa', rating: 5, comment: '¡Tengo una estancia increíble! También estaba celebrando mi aniversario y tuvieron un pequeño detalle. ¡Con una botella de champán y una tarjeta! Eso fue increíble.❤️', cleanliness: 5, location: 5, service: 5, value: 5, createdAt: '2025-09-07', localizedDate: 'septiembre de 2025', hostResponse: '¡Qué alegría leer tu evaluación! Nos alegra mucho que la celebración de vuestro aniversario haya sido aún más especial gracias a nuestro pequeño detalle. ❤️ Siempre seréis bienvenidos aquí, en Areia Bela.' },
]
...
export const mockStaff: Staff[] = [
  { id: 's-1', name: 'Maria Santos', email: 'maria@grandazure.com', role: 'housekeeper', avatar: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=100', phone: '+1 555-111-1111', status: 'active' },
  { id: 's-2', name: 'Carlos Rivera', email: 'carlos@grandazure.com', role: 'housekeeper', avatar: 'https://images.unsplash.com/photo-1599566150163-29194dcabd36?w=100', phone: '+1 555-222-2222', status: 'active' },
  { id: 's-3', name: 'Ana Garcia', email: 'ana@grandazure.com', role: 'housekeeper', avatar: 'https://images.unsplash.com/photo-1607746882042-944635dfe10e?w=100', phone: '+1 555-333-3333', status: 'active' },
  { id: 's-4', name: 'John Smith', email: 'john@grandazure.com', role: 'maintenance', avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100', phone: '+1 555-444-4444', status: 'active' },
  { id: 's-5', name: 'Mike Johnson', email: 'mike@grandazure.com', role: 'maintenance', phone: '+1 555-555-5555', status: 'active' },
  { id: 's-6', name: 'Sarah Lee', email: 'sarah@grandazure.com', role: 'receptionist', phone: '+1 555-666-6666', status: 'active' },
  { id: 's-7', name: 'David Brown', email: 'david@grandazure.com', role: 'manager', phone: '+1 555-777-7777', status: 'active' },
]
...
export const mockProperties: Property[] = [
  { 
    ...
    location: { address: '123 Ocean Boulevard', city: 'Miami Beach', country: 'USA' }, 
